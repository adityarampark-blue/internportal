...
export const mockUsers = [
  ...
  { email: 'priya@example.com', password: 'intern123', role: 'intern' as const, name: 'Priya Sharma', id: '1' },
  { email: 'rahul@example.com', password: 'intern123', role: 'intern' as const, name: 'Rahul Verma', id: '2' },
];
