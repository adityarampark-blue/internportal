import { Intern, Task, Meeting, Document, DailyUpdate, Attendance } from './types';
...
export const mockAttendance: Attendance[] = [
  ...
  { id: '6', internId: 'IN002', date: '2025-02-13', status: 'late', checkIn: '10:15 AM' },
  { id: '7', internId: 'IN003', date: '2025-02-14', status: 'present', checkIn: '08:55 AM' },
];

export const mockUsers = [
  { email: 'admin@portal.com', password: 'admin123', role: 'admin' as const, name: 'Admin User', id: 'admin-1' },
  { email: 'priya@example.com', password: 'intern123', role: 'intern' as const, name: 'Priya Sharma', id: 'IN001' },
  { email: 'rahul@example.com', password: 'intern123', role: 'intern' as const, name: 'Rahul Verma', id: 'IN002' },
];
